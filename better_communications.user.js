...
var ready = false;
var sectorInfoUrl = "https://docs.google.com/spreadsheets/d/1fYPq76wyCrNoKYkNMRCTdOGKP0XNMscHlZaaIOxRrMM/pub?output=csv";
var sectorInfo = [];
...
function createIcon()
{
  addCss("#moreInfo{ bottom: 20px; left: 80px; z-index: 1000; position: absolute; display: inline-block; height: 2pc; padding: 3px 0px; background: transparent url('http://game.asylamba.com/s9/public/css/src/desktop/map/bOption.png') repeat-x scroll 0% 0%; }");
  addCss("#moreInfo a img { position: absolute; top: 5px; left: 5px; width: 22px;}");
  addCss("#moreInfo::before { content: ''; position: absolute; display: block; left: -10px; top: 0px; height: 38px; width: 10px; background: transparent url('http://game.asylamba.com/s9/public/css/src/desktop/map/bLeftOption.png') repeat scroll 0% 0%; }");
  addCss("#moreInfo::after { content: ''; position: absolute; display: block; right: -10px; top: 0px; height: 38px; width: 10px; background: transparent url('http://game.asylamba.com/s9/public/css/src/desktop/map/bRightOption.png') repeat scroll 0% 0%; }");
  ...
  addCss("#moreInfo a.active { background: #510816 none repeat scroll 0% 0%; }");
